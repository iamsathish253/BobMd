var createPackage = {
				...
				function success(data) {
					...
					Xrm.WebApi.updateRecord("cr60a_stg_article_master", articleID, input).then(
						function success(result) {
							...
							Xrm.Utility.closeProgressIndicator();
							var alertStrings = { confirmButtonLabel: "Ok", text: `Package was created successfully with ${selectedRowLength} components.`, title: "Package Creation." };
	...
	publishCost = {
		...
		enableButton: function (formContext) {
			...
			if(formContext.controlDescriptor.Name.startsWith("project_variant_comp_margin") || formContext.controlDescriptor.Name.startsWith("project_variant_margin")){
				return true;
			}
