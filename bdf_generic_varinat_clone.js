	...
	function saveGeneric(source) {
		try {
			var input =
			{
				...
				"bdf_SpecificFinishlkp@odata.bind": (source["_bdf_specificfinishlkp_value"] == null ? null : "/bdf_specificfinishgroups(" + source["_bdf_specificfinishlkp_value"] + ")"), //Added by Sathish 12/9/2024
	...
	async function saveVariant(source, genericGUID, projectGUID) {
		try {
			var input =
			{
				...
				"bdf_SpecificFinish@odata.bind":(source["_bdf_specificfinish_value"] == null ? null : "/bdf_specificfinishgroups(" + source["_bdf_specificfinish_value"] + ")"), //added by Sathish 12/9/2024
